...
- [**SSR - Server-Side Rendering** / Learn more about server-side rendering in Next.js with getServerSideProps.](/docs/basic-features/data-fetching/get-server-side-props)
- [**SSG - Static-Site Generation** / Learn more about static site generation in Next.js with getStaticProps.](/docs/basic-features/data-fetching/get-static-props)
- [**CSR - Client-Side Rendering** / Learn more about client side rendering in Next.js with SWR.](/docs/basic-features/data-fetching/client-side)
...
- [**ISR - Incremental Static Regeneration** / Learn more about Incremental Static Regeneration in Next.js.](/docs/basic-features/data-fetching/incremental-static-regeneration)
